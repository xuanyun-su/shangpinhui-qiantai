<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>验证码:</label>
        <input type="text" placeholder="请输入验证码" v-model="userStore.code" />
...
const getCode = async () => {
  try {
    phone.value && userStore.getCode(phone.value)
  } catch (error: any) {
    alert(error.message)
  }
}
...
const userRegister = () => {
  ...
  try {
    phone.value && userStore.code && password.value && userStore.userRegister(data)
