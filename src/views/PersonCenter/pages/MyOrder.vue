...
import { reqmyOrderList } from '@/api/order'
import type { myorderInfo } from '@/types/trade'
import { ref, onMounted } from 'vue'

const page = ref<string>('1')
const limit = ref<string>('10')
const myOrder = ref<myorderInfo>({} as myorderInfo)
const getData = async () => {
  const result = await reqmyOrderList(page.value, limit.value)
  myOrder.value = result.data
}
const getPageNo = (page1:string)=>{
  page.value = page1
  getData()
}
onMounted(() => {
